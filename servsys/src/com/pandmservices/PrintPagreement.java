...
public class PrintPagreement
{
        ...
        public PrintPagreement (Connection c, int id, String username)
		throws SQLException, TodoException, Exception
	{
		...
		//
		// Get the customer information and put into appropriate variables
		//
		...
		//
		// Create psform variable to contain the planned service form
		//
		...
		//
		// Create etable variable to get equipment covered into the table
		//
	...
	//
	// Put together the vtable (table of visits) for the agreement
	//
	...
	// 
	// Now we have all of the information - start assembling the PS agreement
	//
	// 
	...
	mbody=tmbody14;
        ...
        public static Vector getIndItem(Connection c, int custnum, int contnum, String username)
                throws SQLException, TodoException, Exception
        {
                Vector V = new Vector();
                Statement stmt = c.createStatement();
