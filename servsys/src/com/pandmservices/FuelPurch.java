...
public class FuelPurch
{
	...
	private double total=0; 
        ...
        public FuelPurch (Connection c, int recnum)
	...
	public static void UpdateItem(Connection con, int recnum, String callslip, String descript, String quant, String price)
	...
	public static void AddItem(Connection con, String callslip, String descript, String quant, String price)
                throws SQLException
		        {
	       	        Statement stmt = con.createStatement();
