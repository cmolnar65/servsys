...
public class UniTrans
{
	...
	private String date_posted="";
        ...
        public UniTrans (Connection c, String tranid)
		throws SQLException, TodoException
	{
		Statement stmt = c.createStatement();
	ResultSet rs = stmt.executeQuery("select gnctransaction.transguid, gncaccount.accountname, gnctransaction.description, to_char(gnctransaction.date_posted,'YYYY-MM-DD') as date_posted, gnctransaction.num, gncaccount.type,gncentry.amountnum,  gncentry.amountdenom  from gncaccount where gnctransaction.transguid='"+tranid+"' and gncentry.accountguid=gncaccount.accountguid and gnctransaction.transguid=gncentry.transguid GROUP By gncaccount.accountname, gncaccount.type, gncentry.amountnum, gncentry.amountdenom, gnctransaction.description, gnctransaction.num, gnctransaction.date_posted, gnctransaction.transguid order by gnctransaction.date_posted DESC;");
	...
	{	
		Vector V = new Vector();
		Statement stmt = c.createStatement();
		ResultSet rs = stmt.executeQuery("select gncentry.transguid, gnctransaction.date_posted where gncentry.accountguid='"+actguid+"' and gncentry.transguid=gnctransaction.transguid ORDER BY gnctransaction.date_posted DESC;");
		while(rs.next())
		{
