...
public class SyncSingleInspection
{
        ...
        public SyncSingleInspection (Connection con, Connection conu, String crecnum)
...
/////////////////////////////////////////////
		ResultSet rs = stmt.executeQuery("SELECT crecnum, custnum  FROM inspection where crecnum='"+crecnum+"' and custsite is NULL and sitenum is NULL or (length(custsite)<1 or length(sitenum)<1) ORDER BY custnum;");
                while(rs.next())
                {
