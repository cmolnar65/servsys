...
public class SyncCustPagreement
{
        ...
        public SyncCustPagreement (Connection con, Connection conu, String custsite, String sitenum)
		throws SQLException, TodoException
	{
		...
		ResultSet rs2 = stmt3.executeQuery("SELECT * FROM pagreement where custsite='"+custsite+"' and sitenum='"+sitenum+"';");
		while(rs2.next())
		{
