...
public class SyncSingleCallslip
{
		...
		throws SQLException, TodoException
	{
		...
		ResultSet rs99 = stmt99.executeQuery("SELECT *  FROM callslip where servsync!=2 or servsync is NULL and crecnum='"+crecnum+"' and custsite is not NULL and sitenum is not NULL ORDER BY crecnum;");
		while(rs99.next())
		{
