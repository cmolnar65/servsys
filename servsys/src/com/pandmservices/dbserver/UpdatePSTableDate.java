...
public class UpdatePSTableDate
{
	private String dupdated;

        public UpdatePSTableDate (Connection c,String dupdated)
	...
	public static void UpdateItem(Connection con, String dupdated)
		throws SQLException
	{
        ...
        public String getDateUpdated() { return dupdated; }
}
