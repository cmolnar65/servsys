...
public class HeatLoadValues 
{
	...
	private String heatvalue;
        ...
        public HeatLoadValues (Connection c, String fieldname, String fieldselection)
	...
	public static Vector getIndItem(Connection c, String fieldname, String fieldvalue)
		throws SQLException, TodoException
	{	
		Vector V = new Vector();
		Statement stmt = c.createStatement();
	...
	public String fieldselection() { return fieldselection; }
	public String coolvalue() { return coolvalue; }
	public String heatvalue() { return heatvalue; }
